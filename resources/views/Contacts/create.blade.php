   ...
   <div class="container">
   	<div class="row">
   		<div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
   			<h2>Get In Touch</h2>
   			<p class="text-muted">If you having trouble with this service,please <a href="mailto:{{ config('laracarte.admin_support_email') }}">Ask me question</a></p>
   			...
   			<div class="form-group {{ $errors->has('message') ? 'has-error' : ''}}">
   				...
   				<textarea name="message" class="form-control" rows="10" cols="10" id="message" required="required">{{ old('message') }}
   				</textarea>
